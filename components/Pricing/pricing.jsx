...
const Pricing = () => {
  ...
  return (
    <div id="pricing" className="mb-[100px] pt-[100px]">
      ...
      <div className="max-w-[198px] mb-[80px] mx-auto bg-white/5 border border-[#2D3748] rounded-[32px] p-1 flex flex-wrap items-center justify-center gap-2 ">
        ...
        <div className="max-w-[1215px] mx-auto grid grid-cols-3 gap-8 px-5 ">
            {/* first card */}
            <div className="max-w-[370px]  text-white px-[37px] pt-[72px] bg-white/5 border border-[#2D3748]/80 rounded-3xl">
